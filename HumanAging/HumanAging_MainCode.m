...
Breakpoints_FileName = 'HumanAging_Breakpoints_Lakshmanan_et_al.xls'; 
...
Dataset_Name = [ 'HumanAging','-W',num2str(window_length_val),'-BW', num2str(bin_width),'-SS',num2str(total_sample_sets)]; % name includes details about dataset, window length, bin size, number of samples 
