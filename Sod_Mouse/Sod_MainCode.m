...
main_seed_value = 21 * 10000000;      % seed for random number generator, to ensure reproducible results
...
Breakpoints_FileName = 'Sod_Mouse_Breakpoints_Lakshmanan_et_al.xls'; 
...
Dataset_Name = [ 'Sod-Mouse','-W',num2str(window_length_val),'-BW', num2str(bin_width),'-SS',num2str(total_sample_sets)]; % name includes details about dataset, window length, bin size, number of samples 
